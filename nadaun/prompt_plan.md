...
- [ ] T9: server actions 테스트 — iep-plans, weekly-plans, students
- [ ] T10: 컴포넌트 렌더 테스트 — PlanStatusActions, WeeklyPlanSection 등
- [ ] T11: API route 테스트 — /api/generate, /api/export/*
...
- [ ] T13: updateWeeklyPlan server action
- [ ] T14: WeeklyPlanItem 편집 모드 토글
- [ ] T15: 주차 번호 중복 방지 검증
- [ ] T16: 인라인 수정 E2E 테스트
...
### 테스트 (Phase 9)
- [ ] C11: server actions 테스트 3개+ 파일
- [ ] C12: 컴포넌트 렌더 테스트 2개+ 파일
- [ ] C13: API route 테스트 1개+ 파일
- [ ] C14: 전체 vitest PASS

### 인라인 수정 (Phase 10)
- [ ] C15: 주간계획 수정 가능
- [ ] C16: 수정 후 DB 반영 확인
- [ ] C17: 주차 번호 중복 시 에러 표시
- [ ] C18: 수정 취소 시 원래 값 복원

### 전체
- [ ] C19: 빌드 + 타입체크 + 린트 전체 PASS
